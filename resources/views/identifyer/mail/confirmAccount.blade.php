...
<div class="container" >
    ...
    <form id="send_validation" method="post" class="content" class="registration-form" style="margin-top: -80px;">
        <h1 class="text-center">Activez votre compte</h1>
		<label>
     ...
     function validation()
      {
              $.ajax({
                  ...
                  statusCode: {
                        402: function(xhr) {
                            swal("ERREUR!", "Vous devez insérer votre addresse éléctronique pour activer votre compte.","error", {button: "Reprendre",});
                        } ,

                        201: function(xhr){
                            swal("Validé!","Votre compte a été activé! Vous pouvez acceder à votre compte NuvensPay et jouir de ses services.","success", {button: "Fermer",});
