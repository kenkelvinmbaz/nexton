     ...
     function validation()
      {
              $.ajax({
                  ...
                  statusCode: {
                        402: function(xhr) {
                            swal("ERREUR!", "Votre mot de passe doit contenir plus de 7 caractères, une lettre en majuscule, un caractère spécial et un chiffre, afin de garantir la sécurité de votre compte.","error", {button: "Reprendre",});
                        } ,

                        201: function(xhr){
                            swal("Validé!","Votre mot de passe a été réinitialisé! Veuillez vous connecter sur votre compte avec le nouveau mot de passe","success", {button: "Fermer",});
